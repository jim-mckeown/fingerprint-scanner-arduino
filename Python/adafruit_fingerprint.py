...
* Author(s): ladyada
Modified for FingerprintUtility.py by Jim McKeown 2023
Removed micropython.const and busio.UART
...
class Adafruit_Fingerprint:
    ...
    def __init__(self, uart: serial.Serial, passwd: Tuple[int, int, int, int] = (0, 0, 0, 0)):
